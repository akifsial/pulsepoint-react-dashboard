...
import CreProviderBillingCheckout from "./care-provider-billing-checkout";
import CareProviderProfileCards from "./care-provider-profile-cards";
...
export default CareProviderGetFeaturePage;
