...
const AdminCommunityForum = () => {
  const [selectedButton, setSelectedButton] = useState("Home"); // Default is 'Home'
    ...
    >
      ...
      <div className="flex gap-1">
        <PrimaryButton
          ...
          onClick={() => setSelectedButton("Home")} // Set 'Home' when clicked
        />
        <PrimaryButton
          btnText="Popular"
          showImg={true}
          ...
          onClick={() => setSelectedButton("Popular")} // Set 'Popular' when clicked
        />
      </div>

      {/* Conditionally render posts based on selected button */}
