...
const postList = [
  {
    ...
    desc: "My 78-year-old dad is struggling with mobility, but refuses help at home. Has anyone had success getting through to a <br /> stubborn parent?",
    postImage: postImage,
    ...
    >
      ...
      <div className="flex gap-1">
        <PrimaryButton
          ...
          img={yourHouseIcon}
          imgPosition="left"
          btnClass="flex items-center gap-3 px-4 py-[10px] rounded-[10px] transition-all bg-[#28A2FF] text-white activeborder border-[#000] px-4 w-full md:w-[98px] py-[5.5px] rounded-[20px] text-[#252525] font-medium mb-5"
        />
        <PrimaryButton
          btnText="Popular"
          showImg={true}
          ...
          img={PopularIcon}
          imgPosition="left"
          btnClass="flex items-center gap-3 px-4 py-[10px] rounded-[10px] transition-all bg-[#D9E7EE] text-[#252525] activeborder border-[#000] px-4 w-full md:w-[98px] py-[5.5px] rounded-[20px] text-[#252525] font-medium mb-5"
        />
      </div>
