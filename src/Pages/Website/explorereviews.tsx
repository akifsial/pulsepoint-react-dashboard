...
const reviewsData = [
  ...
  },
  {
    ...
    rating: 4,
    comment: "Good overall experience, but the waiting time could be improved.",
    date: "Oct 8, 2025",
  },
  {
    id: 3,
    ...
    rating: 5,
    comment: "Loved everything about it! Highly recommended for everyone.",
    date: "Oct 6, 2025",
  },
  {
    id: 4,
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              <img
                src={
                  review.image
                    ? `${import.meta.env.VITE_APP_API_IMG_URL}${review.image}`
                    : userDummy
                }
                alt={review.name}
