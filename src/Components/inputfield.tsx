...
const InputField: React.FC<InputFieldProps> = ({
  ...
  return (
    <div className={` ${fieldName} ${errors?.[registerName] ? "mb-3" : ""}`}>
      {label && (
        <div className="flex">
      ...
      <div className="relative ">
        <input
          ...
          className={`mb-1 w-full h-[50px] bg-[#FBFCFD] border border-[#2525251A] rounded-[8px] px-4 font-[Geist] text-[16px] font-normal text-[#1A1A1A] placeholder:text-gray-500 focus:outline-none ${className}`}
          {...rest}
        />
