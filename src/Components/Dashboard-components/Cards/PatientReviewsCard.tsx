...
const PatientReviewsCard: React.FC = () => {
 const sliders = [
  ...
  <div key={index} className="bg-[#FAFAFA] rounded-[8px] p-5 mb-5">
    ...
    <div >
      <p className="text-[16px] text-[#252525] mb-4">
        “{item.sliderDesc}”
      </p>
    </div>
  <div className="flex items-center gap-4 px-4 py-2.5 rounded-[5px]"
  style={item.comment ? { backgroundColor: "#EEF2F5" } : {}}>
  <img src={item.userIcon} alt="" className="w-[43px] h-[43px] object-cover rounded-full"/>
