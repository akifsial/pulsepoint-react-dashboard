...
const CommunityFeed = ({ setOpenBackFeed, setPostIdFeed }) => {
  ...
  const handleParentReply = (parentCommentId) => {
  ...
  const {
    ...
    onSuccess: async () => {
      queryClient.invalidateQueries(["useGetCommunityPost"]);
      toast.success("Like Reply Successfully");
      setComment("");
      setParentCommentReplyValue("");
    },
    onError: (error) => {
  ...
  const handleParentCommentReply = async (postId, parentCommentId) => {
                      ...
                      <div key={key} className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex flex-col mb-1 text-[#252525] leading-tight font-normal">
                          ...
                          <div className="flex gap-2.5 mb-2.5">
                            ...
                            <button
                              onClick={() => handleParentReply(comment.id)}
