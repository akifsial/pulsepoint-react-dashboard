...
const CommunityStep3 = ({ onBack, onClose }) => {
  return (
    <>
      <div className="text-center max-w-[496px] mx-auto mb-2.5 font-normal text-base">
        <h3 className="text-[25px] font-bold leading-8.5 font-[Space Grotesk]">Add topics</h3>
        <p>
  ...
  />
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button
          type="submit"
          className="w-48 bg-black text-white py-[13.5px] px-4 rounded-lg font-semibold text-sm transition-colors duration-300 hover:bg-[#007AB2]"
        >
          Create Community
        </button>
      </div>
