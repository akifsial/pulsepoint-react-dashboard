...
import PatientDetails from "@components/admindashboard/adminpatient/patient-details";
...
import UserCommunity from "../admincare/user-community";
import UserComments from "../admincare/user-comments";
