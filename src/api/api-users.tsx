...
export const ApiAllSavedCareProviders = async (search: string, rating: number, page) => {
  let BASE_URL = `${import.meta.env.VITE_APP_API_URL}user/save-care-provider?search=${search}&limit=3&page=${page}`;
  if (rating) {
